...
export default (props) => (
  <main className="conteiner row justify-content-center align-itens-center">
    {/* about me  */}
    <section
      className="col-10 p-5 conteiner d-flex justify-content-center align-items-center"
      id="about"
    >
      <div className="d-flex flex-row h-100 d-flex justify-content-center align-items-center">
        <aside className="w-50 position-relative box">
          <img
            ...
            className="image rounded rounded-2 "
          />
    ...
    {/* contact */}
    <section
      className="col-10 p-5 d-flex justify-content-center conteiner"
      id="contact"
    >
      <article
        className="w-75 d-flex flex-column justify-content-center align-items-center rounded-4 
                                col-ms-2 text-center"
        style={{ width: "980px", height: "277px", background: "#292C36" }}
      >
        <h1>Have any project in mind ?</h1>
        <a href="https://wa.me/5535998163938" target="_blank">
